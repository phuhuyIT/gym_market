...
GO
Insert into Lectures(Lecture_ID, Course_ID, Title, [Order], Duration) Values ('vbt-jc-lecture-001', '4946c22a-08e2-4d12-8387-43f7d0de55b5', 'VBT fundamentals and why bar speed matters', 1, 12)
GO
Insert into Lecture_Materials(Material_ID, Lecture_ID, Material_Type, Material_Content) Values ('vbt-jc-material-001', 'vbt-jc-lecture-001', 'TEXT', 'Velocity-Based Training uses bar speed to judge how heavy a set really is on that day. Instead of only relying on percentages, the athlete tracks movement velocity and adjusts the load when speed shows fatigue, poor readiness, or an underloaded set. For bodybuilding and strength work, VBT helps keep hard sets productive without turning every session into a max-effort test.')
GO
Insert into Lectures(Lecture_ID, Course_ID, Title, [Order], Duration) Values ('vbt-jc-lecture-002', '4946c22a-08e2-4d12-8387-43f7d0de55b5', 'Reading velocity zones for strength and power', 2, 15)
GO
Insert into Lecture_Materials(Material_ID, Lecture_ID, Material_Type, Material_Content) Values ('vbt-jc-material-002', 'vbt-jc-lecture-002', 'TEXT', 'Fast reps usually train power and intent; slower but controlled reps usually reflect heavier strength work. A practical guide is to reserve very fast lifts for explosive practice, moderate velocities for strength-speed work, and slower velocities for heavy strength sets. The goal is not to chase one perfect number, but to learn the speed range that matches the training goal.')
GO
Insert into Lectures(Lecture_ID, Course_ID, Title, [Order], Duration) Values ('vbt-jc-lecture-003', '4946c22a-08e2-4d12-8387-43f7d0de55b5', 'Setting loads with velocity loss targets', 3, 18)
GO
Insert into Lecture_Materials(Material_ID, Lecture_ID, Material_Type, Material_Content) Values ('vbt-jc-material-003', 'vbt-jc-lecture-003', 'TEXT', 'Velocity loss tells you when a set has drifted too far from the target stimulus. For power, stop the set after a small drop in speed so every rep stays explosive. For hypertrophy, a larger velocity loss can be acceptable because fatigue is part of the goal. For heavy strength, use velocity loss to avoid junk reps that add fatigue without improving quality.')
GO
Insert into Lectures(Lecture_ID, Course_ID, Title, [Order], Duration) Values ('vbt-jc-lecture-004', '4946c22a-08e2-4d12-8387-43f7d0de55b5', 'Building a VBT workout for squat, bench, and deadlift', 4, 20)
GO
Insert into Lecture_Materials(Material_ID, Lecture_ID, Material_Type, Material_Content) Values ('vbt-jc-material-004', 'vbt-jc-lecture-004', 'TEXT', 'A simple VBT session starts with warm-up sets where the athlete records bar speed at each load. Choose the working weight when the speed matches the goal for that lift. On squat and bench, keep technique strict and compare speeds only against reps with the same depth and pause style. On deadlift, reset each rep so the device reads consistent starts.')
GO
Insert into Lectures(Lecture_ID, Course_ID, Title, [Order], Duration) Values ('vbt-jc-lecture-005', '4946c22a-08e2-4d12-8387-43f7d0de55b5', 'Tracking readiness and adjusting weekly progression', 5, 16)
GO
Insert into Lecture_Materials(Material_ID, Lecture_ID, Material_Type, Material_Content) Values ('vbt-jc-material-005', 'vbt-jc-lecture-005', 'TEXT', 'Use VBT trends to make weekly decisions. If the same load moves faster than usual with clean technique, the athlete may be ready to add weight. If warm-up speeds are clearly slower, reduce load or volume and protect recovery. Over several weeks, track the estimated strength curve, average working-set speed, and how much velocity drops across sets.')
GO
