...
namespace GymMarket.API.Migrations
{
    ...
    [Migration("20260707073027_AddAssignmentFeedbackHistory")]
    partial class AddAssignmentFeedbackHistory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GymMarket.API.Models.AssignmentFeedbackEntry", b =>
                {
                    b.Property<string>("FeedbackEntryId")
                        .HasMaxLength(50)
                        .IsUnicode(false)
                    ...
                    b.HasKey("FeedbackEntryId");

                    b.HasIndex("SubmissionId");

                    b.HasIndex("SubmissionId", "CreatedAt");

                    b.ToTable("Assignment_Feedback_Entries", (string)null);
                });

            modelBuilder.Entity("GymMarket.API.Models.AssignmentRubricCriterion", b =>
                {
                    ...
                    b.ToTable("Assignment_Rubric_Criteria", (string)null);
                });

            modelBuilder.Entity("GymMarket.API.Models.AssignmentRubricScore", b =>
                {
                    b.Property<string>("RubricScoreId")
                        .HasMaxLength(50)
                        .IsUnicode(false)
                        .HasColumnType("varchar(50)")
                    ...
                    b.ToTable("Assignment_Rubric_Scores", (string)null);
                });
            ...
            modelBuilder.Entity("GymMarket.API.Models.AssignmentSubmission", b =>
                {
                    ...
                    b.Property<DateTime?>("SimilarityCheckedAt")
                        .HasColumnType("datetime")
                        .HasColumnName("Similarity_Checked_At");

                    b.Property<string>("SimilarityFlags")
                        .HasMaxLength(1000)
                        .HasColumnType("nvarchar(1000)")
                        .HasColumnName("Similarity_Flags");

                    b.Property<string>("SimilarityMatchedStudentName")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)")
                        .HasColumnName("Similarity_Matched_Student_Name");

                    b.Property<string>("SimilarityMatchedSubmissionId")
                        .HasMaxLength(50)
                        .IsUnicode(false)
                        .HasColumnType("varchar(50)")
                        .HasColumnName("Similarity_Matched_Submission_ID");

                    b.Property<decimal?>("SimilarityScorePercent")
                        .HasColumnType("decimal(5, 2)")
            ...
            modelBuilder.Entity("GymMarket.API.Models.CourseAnnouncement", b =>
                {
                    ...
                    b.HasIndex("CourseId", "IsPinned", "PublishedAt");

                    b.HasIndex("CourseId", "IsPublished", "PublishedAt");
            ...
            modelBuilder.Entity("GymMarket.API.Models.CourseCertificateSetting", b =>
                {
                    b.Property<string>("CourseId")
                        .HasMaxLength(50)
                        .IsUnicode(false)
                    ...
                    b.Property<decimal?>("MinimumFinalGradePercent")
                        .HasColumnType("decimal(5, 2)")
                        .HasColumnName("Minimum_Final_Grade_Percent");

                    b.Property<bool>("RequirePublishedAssignments")
                        .HasColumnType("bit")
                        .HasColumnName("Require_Published_Assignments");

                    b.Property<bool>("RequirePublishedQuizzes")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(true)
                        .HasColumnName("Require_Published_Quizzes");

                    b.Property<decimal>("RequiredAssignmentPercent")
                        .HasColumnType("decimal(5, 2)")
                        .HasColumnName("Required_Assignment_Percent");

                    b.Property<decimal>("RequiredLecturePercent")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(5, 2)")
                    ...
                    b.ToTable("Course_Certificate_Settings", (string)null);
                });
            ...
            modelBuilder.Entity("GymMarket.API.Models.CourseLiveSession", b =>
                {
                    ...
                    b.ToTable("Course_Live_Sessions", (string)null);
                });
            ...
            modelBuilder.Entity("GymMarket.API.Models.CourseQuiz", b =>
                {
                    ...
                    b.Property<bool>("RequireHonorCode")
                        .HasColumnType("bit")
                        .HasColumnName("Require_Honor_Code");
                    ...
                    b.Property<bool>("TrackProctoringSignals")
                        .HasColumnType("bit")
                        .HasColumnName("Track_Proctoring_Signals");
            ...
            modelBuilder.Entity("GymMarket.API.Models.CourseStudyGroup", b =>
                {
                    ...
                    b.Property<bool>("IsDefaultCohort")
                        .HasColumnType("bit")
                    ...
                    b.HasIndex("CourseId", "IsDefaultCohort")
                        .IsUnique()
                        .HasFilter("[Is_Default_Cohort] = 1");

                    b.ToTable("Course_Study_Groups", (string)null);
                });
            ...
            modelBuilder.Entity("GymMarket.API.Models.QuizAttempt", b =>
                {
                    ...
                    b.Property<int>("FocusLostCount")
                        .HasColumnType("int")
                        .HasColumnName("Focus_Lost_Count");
                    ...
                    b.Property<bool>("HonorCodeAccepted")
                        .HasColumnType("bit")
                        .HasColumnName("Honor_Code_Accepted");
                    ...
                    b.Property<int>("PasteEventCount")
                        .HasColumnType("int")
                        .HasColumnName("Paste_Event_Count");

                    b.Property<int>("ProctoringEventCount")
                        .HasColumnType("int")
                        .HasColumnName("Proctoring_Event_Count");

                    b.Property<string>("ProctoringFlags")
                        .HasMaxLength(1000)
                        .HasColumnType("nvarchar(1000)")
                        .HasColumnName("Proctoring_Flags");

                    b.Property<bool>("ProctoringReviewRequired")
                        .HasColumnType("bit")
                        .HasColumnName("Proctoring_Review_Required");

                    b.Property<string>("QuestionOrderSnapshot")
                        .HasColumnType("nvarchar(max)")
                    ...
                    b.Property<int>("SuspiciousActivityScore")
                        .HasColumnType("int")
                        .HasColumnName("Suspicious_Activity_Score");
            ...
            modelBuilder.Entity("GymMarket.API.Models.AssignmentFeedbackEntry", b =>
                {
                    b.HasOne("GymMarket.API.Models.AssignmentSubmission", "Submission")
            ...
            modelBuilder.Entity("GymMarket.API.Models.AssignmentRubricScore", b =>
                {
                    b.HasOne("GymMarket.API.Models.AssignmentRubricCriterion", "Criterion")
                        .WithMany("Scores")
            ...
            modelBuilder.Entity("GymMarket.API.Models.CourseAnnouncement", b =>
                {
                    ...
                    b.HasOne("GymMarket.API.Models.AppUser", "CreatedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("GymMarket.API.Models.CourseCertificateSetting", b =>
                {
                    b.HasOne("GymMarket.API.Models.Course", "Course")
                        ...
                        .HasForeignKey("GymMarket.API.Models.CourseCertificateSetting", "CourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("GymMarket.API.Models.CourseStudyGroup", b =>
                {
                    b.HasOne("GymMarket.API.Models.Conversation", "Conversation")
                        .WithOne()
                        .HasForeignKey("GymMarket.API.Models.CourseStudyGroup", "ConversationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("GymMarket.API.Models.Course", b =>
                {
                    ...
                    b.Navigation("CourseLiveSessions");
