...
namespace GymMarket.API.Migrations
{
    ...
    [Migration("20241008150307_mergeIdentityWithExistedDB")]
    partial class mergeIdentityWithExistedDB
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GymMarket.API.Models.Student", b =>
                {
                    b.HasOne("GymMarket.API.Models.AppUser", "AppUser")
                        .WithOne("Student")
                        .HasForeignKey("GymMarket.API.Models.Student", "AppUserId")
            ...
            modelBuilder.Entity("GymMarket.API.Models.Trainer", b =>
                {
                    b.HasOne("GymMarket.API.Models.AppUser", "AppUser")
                        .WithOne("Trainer")
                        .HasForeignKey("GymMarket.API.Models.Trainer", "AppUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
